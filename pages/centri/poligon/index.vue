<template>
  <h1 class="header">Испитни Центри (полигонско возење)</h1>
  <div class="wrapper">
    <div
...
useSeoMeta({
  title: "Статистики според испитни центри (полигон)",
  description:
  ...
  ogTitle: "Статистики според испитни центри (полигон)",
  ogDescription:
    "Откриј трендови во разни испитни центри и на кој обид минат луѓето во градовите. Одберете ги најдобрите возачки училишта според вистински резултати.",
...
onMounted(async () => {
  chartData.value = apiStore.data.by_website_poligon;
});
